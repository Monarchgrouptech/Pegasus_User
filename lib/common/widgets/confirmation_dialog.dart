      ...
      child: PointerInterceptor(
        child: SizedBox(width: 500, child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
              child: Image.asset(icon, width: 50, height: 50, color: Theme.of(context).disabledColor),
            ),
            ...
            title != null ? Padding(
              ...
              child: Text(
                ...
                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).textTheme.bodyMedium!.color),
              ),
            ) : const SizedBox(),
              ...
              return !orderController.isLoading ? Row(children: [
                Expanded(child: TextButton(
                  ...
                  style: TextButton.styleFrom(
                    backgroundColor: Theme.of(context).secondaryHeaderColor.withValues(alpha: 0.2), minimumSize: const Size(Dimensions.webMaxWidth, 50), padding: EdgeInsets.zero,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                  ),
                  child: Text(
