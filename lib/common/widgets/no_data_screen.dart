          ...
          fromAddress ? InkWell(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.add_circle_outline_sharp, size: 18.0, color: Theme.of(context).textTheme.bodyMedium!.color),
                  Text('add_address'.tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
                ],
              ),
            ),
          ) : const SizedBox(),
