        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            isDesktop ? ReadMoreText(
              ...
              trimLines: 3,
              colorClickableText: Theme.of(context).textTheme.bodyMedium?.color,
              lessStyle: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color),
              trimCollapsedText: 'show_more'.tr,
              trimExpandedText: ' ${'show_less'.tr}',
              moreStyle: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color),
