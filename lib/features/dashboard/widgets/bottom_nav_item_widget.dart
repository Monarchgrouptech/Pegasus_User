      ...
      child: InkWell(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Image.asset(
            ...
            color: isSelected ? Colors.green : Theme.of(context).textTheme.bodyMedium!.color!,
          ),
          ...
          Text(
            title,
            style: robotoRegular.copyWith(color: isSelected ? Colors.green : Theme.of(context).textTheme.bodyMedium!.color!, fontSize: 12),
          ),
