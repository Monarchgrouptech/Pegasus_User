    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        Align(
          ...
          child: Text('login'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).textTheme.bodyLarge!.color)),
        ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('remember_me'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
              ],
            ),
          ),
          ...
          TextButton(
            ...
            child: Text('${'forgot_password'.tr}?', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
          ),
        ]),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text('do_not_have_account'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Text('sign_up'.tr, style: robotoMedium.copyWith(color: Colors.red)),
            ),
          ),
        ]),
        ...
        onOtpViewClick != null ? Column(children: [
          Text('or'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),

          Row(mainAxisSize: MainAxisSize.min, children: [
            Text('sign_in_with'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

            InkWell(
              onTap: onOtpViewClick,
              child: Text('otp'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color, decoration: TextDecoration.underline)),
            ),
          ]),
        ]) : const SizedBox(),
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('remember_me'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color)),
                  ],
                ),
              ),
              ...
              TextButton(
                ...
                child: Text('${'forgot_password'.tr}?', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color)),
              ),
            ]),
            ...
            child: CustomInkWell(
              ...
              child: Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('otp_sign_in'.tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
                ]),
              ),
            ),
          ) : const SizedBox(),
