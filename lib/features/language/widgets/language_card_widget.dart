    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: !fromWeb ? BoxDecoration(
          color: localizationController.selectedLanguageIndex == index ? Theme.of(context).secondaryHeaderColor.withValues(alpha: 0.05) : null,
          ...
          color: localizationController.selectedLanguageIndex == index ? Theme.of(context).secondaryHeaderColor.withValues(alpha: 0.05) : Theme.of(context).cardColor,
          borderRadius: BorderRadius.circular(Dimensions.radiusLarge),
        ...
        child: Row(children: [
          ...
          localizationController.selectedLanguageIndex == index ? Icon(Icons.check_circle, color: Theme.of(context).textTheme.bodyMedium!.color, size: 25) : const SizedBox(),
