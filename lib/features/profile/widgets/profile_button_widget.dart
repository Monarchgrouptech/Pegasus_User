        ...
        child: Row(children: [
          ...
          isButtonActive != null ? Transform.scale(
            ...
            child: CupertinoSwitch(
              ...
              activeTrackColor: Theme.of(context).secondaryHeaderColor.withValues(alpha: 0.8),
              onChanged: (bool? value) => onTap(),
              inactiveTrackColor: Theme.of(context).secondaryHeaderColor.withValues(alpha: 0.4),
            ),
          ) : const SizedBox()
        ]),
      ),
