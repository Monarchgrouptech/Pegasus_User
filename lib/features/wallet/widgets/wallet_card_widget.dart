            ...
            Stack(children: [
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  Text('wallet_amount'.tr,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color)),
                  ...
                  Row(children: [
                    ...
                    Get.find<SplashController>().configModel!.addFundStatus! && Get.find<SplashController>().configModel!.digitalPayment! ? JustTheTooltip(
                      ...
                      child: InkWell(
                        ...
                        child: Icon(Icons.info_outline, color: Theme.of(context).textTheme.bodyMedium!.color),
                      ),
                    ) : const SizedBox(),
                  ]),
                ]),
